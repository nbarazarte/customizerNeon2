          ...
          <div class="card-body" style="background-color: #D3D3D3">
            ...
            <div class="cc-selector">
			  ...
			  <figure class="figure">
                ...
                <input type="radio" name="colores" value="durazno" id="duraznoColor" checked onchange="deshabiltarBotonCart()"> 
			  ...
			  <figure class="figure">
                ...
                <input type="radio" name="colores" value="naranja" id="naranjaColor" checked onchange="deshabiltarBotonCart()"> 
                <label class="drinkcard-cc-colores naranjaColor" for="naranjaColor"></label> 
              ...
              <figure class="figure">
                ...
                <label class="drinkcard-cc-colores fucsiaColor" for="fucsiaColor"></label> 

                <figcaption class="figure-caption text-center" style="font-size: 8px; color: #000000; position: relative; top: -21px; left: 5px;">FUCSIA</figcaption>
